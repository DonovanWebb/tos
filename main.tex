...
\usepackage{graphicx}
\usepackage{iopams}
%\usepackage[doi=false,isbn=false,url=false,eprint=false, backend=biber, style=phys]{biblatex}
\usepackage[
    backend=biber,
    style=nature,
    url=false, 
...
%% \end{itemize}
    ...
    %% relationship as shown in fig , featuring a global maximum
...
%% center. How does this effect noise affecting decoherence? and
%% shorten paragraph.
...
\begin{figure}
  ...
  \end{center}
  \caption{\textbf{a)} The blade trap used for the carrier nulling
    proof-of-principle experiment. In blue are the RF blades providing
    the radial pseudopotential whilst in red are the DC end caps
    providing the axial potential. \textbf{b)} The NPL trap to be used
    in the ``FastGates'' experiment. This is a microfabricated,
